...
public class MainWindow
{
    ...
    public MainWindow()
    {
        ...
        inputs[ShoeConfig.ShoeConfigParameter.ToeL1Angle] = new NumberInput("Toe L 1 Angle", editModeConfig.ToeL1Angle);
        ...
        inputs[ShoeConfig.ShoeConfigParameter.ToeL2Angle] = new NumberInput("Toe L 2 Angle", editModeConfig.ToeL2Angle);
        ...
        inputs[ShoeConfig.ShoeConfigParameter.ToeR1Angle] = new NumberInput("Toe R 1 Angle", editModeConfig.ToeR1Angle);
        ...
        inputs[ShoeConfig.ShoeConfigParameter.ToeR2Angle] = new NumberInput("Toe R 2 Angle", editModeConfig.ToeR2Angle);
